...
mkdir -p "$darkPath/configs/variables"

sass-export "$darkTempPath/configs/variables/_breakpoint.scss" -o "$darkPath/configs/variables/_breakpoint.json" -d "$importPath"
sass-export "$darkTempPath/configs/variables/_color.scss" -o "$darkPath/configs/variables/_color.json" -d "$importPath"
sass-export "$darkTempPath/configs/variables/_font.scss" -o "$darkPath/configs/variables/_font.json" -d "$importPath"
sass-export "$darkTempPath/configs/variables/_radius.scss" -o "$darkPath/configs/variables/_radius.json" -d "$importPath"
sass-export "$darkTempPath/configs/variables/_shadow.scss" -o "$darkPath/configs/variables/_shadow.json" -d "$importPath"
sass-export "$darkTempPath/configs/variables/_space.scss" -o "$darkPath/configs/variables/_space.json" -d "$importPath"
sass-export "$darkTempPath/configs/variables/_global.scss" -o "$darkPath/configs/variables/_global.json" -d "$importPath"

mkdir -p "$darkPath/configs/mixins"

sass-export "$darkTempPath/configs/mixins/_mediaquery.scss" -o "$darkPath/configs/mixins/_mediaquery.json" -d "$importPath"
sass-export "$darkTempPath/configs/mixins/_placeholder.scss" -o "$darkPath/configs/mixins/_placeholder.json" -d "$importPath"
sass-export "$darkTempPath/configs/mixins/_safearea.scss" -o "$darkPath/configs/mixins/_safearea.json" -d "$importPath"

mkdir -p "$darkPath/configs/themes"

sass-export "$darkTempPath/configs/themes/_theme-common.scss" -o "$darkPath/configs/themes/_theme-common.json" -d "$importPath"
sass-export "$darkTempPath/configs/themes/_theme-light.scss" -o "$darkPath/configs/themes/_theme-light.json" -d "$importPath"
sass-export "$darkTempPath/configs/themes/_theme-dark.scss" -o "$darkPath/configs/themes/_theme-dark.json" -d "$importPath"
sass-export "$darkTempPath/configs/themes/_convert.scss" -o "$darkPath/configs/themes/_convert.json" -d "$importPath"

mkdir -p "$darkPath/styles/bases"

sass-export "$darkTempPath/styles/bases/_root-light.scss" -o "$darkPath/styles/bases/_root-light.json" -d "$importPath"
sass-export "$darkTempPath/styles/bases/_root-dark.scss" -o "$darkPath/styles/bases/_root-dark.json" -d "$importPath"
sass-export "$darkTempPath/styles/bases/_reset.scss" -o "$darkPath/styles/bases/_reset.json" -d "$importPath"
sass-export "$darkTempPath/styles/bases/_html.scss" -o "$darkPath/styles/bases/_html.json" -d "$importPath"

mkdir -p "$darkPath/styles/layouts"

sass-export "$darkTempPath/styles/layouts/_section.scss" -o "$darkPath/styles/layouts/_section.json" -d "$importPath"
sass-export "$darkTempPath/styles/layouts/_grid.scss" -o "$darkPath/styles/layouts/_grid.json" -d "$importPath"
sass-export "$darkTempPath/styles/layouts/_box.scss" -o "$darkPath/styles/layouts/_box.json" -d "$importPath"
sass-export "$darkTempPath/styles/layouts/_card.scss" -o "$darkPath/styles/layouts/_card.json" -d "$importPath"
sass-export "$darkTempPath/styles/layouts/_joint.scss" -o "$darkPath/styles/layouts/_joint.json" -d "$importPath"

mkdir -p "$darkPath/styles/elements"

sass-export "$darkTempPath/styles/elements/_text.scss" -o "$darkPath/styles/elements/_text.json" -d "$importPath"
sass-export "$darkTempPath/styles/elements/_button.scss" -o "$darkPath/styles/elements/_button.json" -d "$importPath"
sass-export "$darkTempPath/styles/elements/_badge.scss" -o "$darkPath/styles/elements/_badge.json" -d "$importPath"
sass-export "$darkTempPath/styles/elements/_list.scss" -o "$darkPath/styles/elements/_list.json" -d "$importPath"
sass-export "$darkTempPath/styles/elements/_table.scss" -o "$darkPath/styles/elements/_table.json" -d "$importPath"
sass-export "$darkTempPath/styles/elements/_form.scss" -o "$darkPath/styles/elements/_form.json" -d "$importPath"
sass-export "$darkTempPath/styles/elements/_iframe.scss" -o "$darkPath/styles/elements/_iframe.json" -d "$importPath"
sass-export "$darkTempPath/styles/elements/_icon.scss" -o "$darkPath/styles/elements/_icon.json" -d "$importPath"
sass-export "$darkTempPath/styles/elements/_alert.scss" -o "$darkPath/styles/elements/_alert.json" -d "$importPath"
sass-export "$darkTempPath/styles/elements/_wysiwyg.scss" -o "$darkPath/styles/elements/_wysiwyg.json" -d "$importPath"

mkdir -p "$darkPath/styles/utilities"

sass-export "$darkTempPath/styles/utilities/_display.scss" -o "$darkPath/styles/utilities/_display.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_size.scss" -o "$darkPath/styles/utilities/_size.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_flex.scss" -o "$darkPath/styles/utilities/_flex.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_space.scss" -o "$darkPath/styles/utilities/_space.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_margin.scss" -o "$darkPath/styles/utilities/_margin.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_padding.scss" -o "$darkPath/styles/utilities/_padding.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_centering.scss" -o "$darkPath/styles/utilities/_centering.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_overflow.scss" -o "$darkPath/styles/utilities/_overflow.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_scroll.scss" -o "$darkPath/styles/utilities/_scroll.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_ellipsis.scss" -o "$darkPath/styles/utilities/_ellipsis.json" -d "$importPath"
sass-export "$darkTempPath/styles/utilities/_clearfix.scss" -o "$darkPath/styles/utilities/_clearfix.json" -d "$importPath"