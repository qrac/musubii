...
sass-export "$staticLightTempPath/styles/utilities/_centering.scss" -o "$staticLightPath/styles/utilities/_centering.json" -d "$importPath"
...
#sass-export "$dynamicLightTempPath/styles/utilities/_centering.scss" -o "$dynamicLightPath/styles/utilities/_centering.json" -d "$importPath"
