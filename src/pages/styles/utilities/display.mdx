...
[[warning | Warning]]
| \*Hidden は`position: absolute; opacity: 0; z-index: -1` を Display ユーティリティと同じの要領で付与できるようにしたモディファイアです。[Form](/styles/elements/form) の Radio や Checkbox など、デフォルトの HTML タグ機能を残して装飾する場合に用います。メディアクエリ版はありません。
