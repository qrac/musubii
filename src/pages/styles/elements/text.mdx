...
| ------------------- | ------------------- | ---------------- | ---------------- | ---------------- | ---------------- | ---------------- | ---------------- | ---------------- | ---------------- | ---------------- |
| `.is-weight-normal` | `.is-weight-strong` | `.is-weight-100` | `.is-weight-200` | `.is-weight-300` | `.is-weight-400` | `.is-weight-500` | `.is-weight-600` | `.is-weight-700` | `.is-weight-800` | `.is-weight-900` |
...
`.text` に付与することで `text-align` や `vertical-align` の調整ができるモディファイア。
...
| Justify       | Baseline       | Top       | Middle       | Bottom       |
| ------------- | -------------- | --------- | ------------ | ------------ |
| `.is-justify` | `.is-baseline` | `.is-top` | `.is-middle` | `.is-bottom` |

## Wrap

`.text` に付与することで文章の折り返し調整ができるモディファイア。
