...
- `.is-dark` は最も濃くなります
- `.is-dark-{num}` の数値は `1` から `9` までで増えるほど薄くなります
...
- `.is-light` は最も濃くなります
- `.is-light-{num}` の数値は `1` から `9` までで増えるほど薄くなります
...
- 数値は最小 `100` からステップ 100 毎に `900` まで
...
- `.is-right` で文章を右寄せにします
- `.is-center` で文章を中央寄せにします
- `.is-left` で文章を左寄せにします
- `.is-justify` で文章を両端揃えにします
...
| ------------ | ------------------- | ------------------- | -------------------- | ----------------- |
| `.is-right`  | `.fablet:is-right`  | `.tablet:is-right`  | `.desktop:is-right`  | `.wide:is-right`  |
| `.is-center` | `.fablet:is-center` | `.tablet:is-center` | `.desktop:is-center` | `.wide:is-center` |
| `.is-left`   | `.fablet:is-left`   | `.tablet:is-left`   | `.desktop:is-left`   | `.wide:is-left`   |
